    ...
    <>
      <label className='themeSwitcherThree relative inline-flex cursor-pointer select-none items-center '>
        <input
          ...
          className='sr-only'
        />
        <div className='shadow-md flex h-[30px] w-[60px] items-center  gap-1 p-1 justify-center rounded-md bg-white'>
          <span
            className={`flex h-full w-full items-center justify-center rounded ${
              !isDarkMode ? ' text-yellow-500 border-b border-yellow-500' : 'text-gray-500'
            }`}
          >
            <svg
              width='16'
          ...
          <span
            className={`flex h-full w-full items-center justify-center rounded ${
              isDarkMode ? 'bg-gradient-to-t from-blue-900 to-violet-900 text-white' : 'text-body-color'
            }`}
          >
            <svg
              width='16'
